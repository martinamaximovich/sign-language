...
Original file is located at
    https://colab.research.google.com/drive/1QXquafObgYsxmg8kzwMr1zZEsP_1R7mo

mm5775 Martina Maximovich
...
class SignLanguage:
    ...
    def create_model(self):
        ...
        #used tenserflow documentation @ https://www.tensorflow.org/tutorials/images/cnn
    ...
    def prepare_data(self, images, labels):
        ...
        x_train, x_test, y_train, y_test=train_test_split(images, labels, test_size=0.5, random_state=20)
    ...
    def train(self, batch_size:int=128, epochs:int=50, verbose:int=1):
        ...
        #history = self.model.fit(batch_size=batch_size, epochs=epochs, verbose=verbose, train_images, train_labels, epochs=epochs, 
                    #validation_data=(test_images, test_labels))
        
        history = self.model.fit(*self.data["train"], validation_data = self.data["test"], batch_size=batch_size, epochs=epochs, verbose=verbose)
        return history
